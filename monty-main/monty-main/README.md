...
**About:** In this project, I have created a simple interpreter for Monty ByteCodes. The interpreter reads a bytecode file and executes the bytecode commands.
### The Monty language
...
[Akrem Assefa](https://github.com/assefaakrem/monty/
